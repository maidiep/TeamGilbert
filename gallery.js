...
$("#submit").on("click", function(event) {
  ...
  $("#cookiesAndCream-total").text(
    "cookiesAndCream Total: " + cookiesAndCreamTotal
  );
  $("#rainbowUnicode-total").text(
    "rainbowUnicode Total: " + rainbowUnicodeTotal
  );
